  ...
  return (
    <div className="card p-5">
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        <span className="text-xs text-slate-500 dark:text-slate-400">via Gemini AI</span>
      </div>
          ...
          <button
            ...
            className={cn(
              ...
              tone === t
                ...
                : "border-slate-300 dark:border-slate-700/60 bg-transparent text-slate-600 dark:text-slate-300 hover:border-slate-400 dark:hover:border-slate-500"
            )}
      ...
      <div className="mt-4 space-y-3">
        <div className="rounded-xl border border-slate-200 dark:border-slate-700/50 bg-white dark:bg-[#0F172A] p-3">
          <div className="flex items-center justify-between">
            <p className="text-xs font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400">Subject</p>
          ...
          <p className="mt-1 text-sm font-semibold text-slate-900 dark:text-slate-100">{result.emailTemplate.subject}</p>
        </div>
        <div className="rounded-xl border border-slate-200 dark:border-slate-700/50 bg-white dark:bg-[#0F172A] p-3">
          <div className="flex items-center justify-between">
            <p className="text-xs font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400">Email body</p>
          ...
          <pre className="mt-1 whitespace-pre-wrap font-sans text-sm leading-relaxed text-slate-700 dark:text-slate-200">
